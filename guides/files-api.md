...
>[!NOTE]
> A single file can be referenced simultaneously by multiple Messages or tools.
...
- [2. Retrieve a file by its ID](#2-retrieve-a-file-by-its-id)
- [3. Delete a file by its ID](#3-delete-a-file-by-its-id)
...
- `file_id` references are immutable; updating content requires a new upload.
